...
$(document).ready(function(){
    ...
    $('.anavmfe__accordion__item__name').wrap('<a class="filter-class"></a>').css({"display": "inline", "margin-right": "20px","cursor": "pointer"});
    var filterItem = document.querySelectorAll('.anavmfe__accordion__row_item input')
